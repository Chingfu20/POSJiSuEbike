...
<body>
    ...
    createChart(document.getElementById("productChart"), "Products", productCount, 'rgba from Text
255, 99, 132, 0.2)', 'rgba(255, 99, 132, 1)');
    createChart(document.getElementById("salesChart"), "Sales (Total)", salesAmount, 'rgba(75, 192, 192, 0.2)', 'rgba(75, 192, 192, 1)');
    createChart(document.getElementById("todayOrdersChart"), "Today's Orders", today or 'rgba(255, 0, 0, 1)');
        document.getElementById("customerCountText").innerText = customerCount;
    createChart(document.getElementById("totalOrdersChart"), "Total Orders", totalOrders, 'rgba(54, 162, 235, 0.2)', 'rgba(54, 162, 235, 1)');
  });
</script>
</body>
</html>
