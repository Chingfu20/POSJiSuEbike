                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="products-view.php?id=<?= urlencode($item['id']); ?>" class="btn btn-secondary btn-sm">View</a>
                                    <a href="products-add.php?id=<?= urlencode($item['id']); ?>" class="btn btn-primary btn-sm">+</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
