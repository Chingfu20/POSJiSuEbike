                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="products-edit?id=<?= urlencode($item['id']); ?>" class="btn btn-success btn-sm">Edit</a>
                                    <a href="products-delete?id=<?= urlencode($item['id']); ?>" class="btn btn-danger btn-sm">Delete</a>
                                    <a href="products-view?id=<?= urlencode($item['id']); ?>" class="btn btn-info btn-sm">View</a>
                                    <a href="products_increment?id=<?= urlencode($item['id']); ?>" 
   class="btn btn-warning btn-sm" 
   title="Increment Quantity">+</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
