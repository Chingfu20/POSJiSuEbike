                                ...
                                <table style="width:100%;" cellpadding="5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="1" style="font-weight: bold;" id="amountPaidDisplay"><?= number_format($amountPaid, 0); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" align="end" style="font-weight: bold;">Change:</td>
                                            <td colspan="1" style="font-weight: bold;" id="changeAmountDisplay"><?= number_format($changeAmount, 0); ?></td>
                                        </tr>
                                        <tr>
